...
@Component({
  ...
  template: `
    <svg
      viewBox="0 0 24 24"
      aria-hidden="true"
      class="size-[1.35rem] fill-none stroke-current"
      [class.rtl:-scale-x-100]="name() === 'chevron'"
    >
      @switch (name()) {
        @case ('home') {
        ...
        @case ('star') {
          <path d="M12 4.5 14.2 9l5 .7-3.6 3.5.9 5-4.5-2.4L7.5 18.2l.9-5L4.8 9.7l5-.7z" />
        }
        @case ('star-on') {
          <path class="fill-current" d="M12 4.5 14.2 9l5 .7-3.6 3.5.9 5-4.5-2.4L7.5 18.2l.9-5L4.8 9.7l5-.7z" />
        }
      }
    </svg>
  `,
